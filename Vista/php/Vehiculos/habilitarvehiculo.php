  ...
  <div class="container">
      ...
      <form id="formagregarvehiculo" action="">
        ...
        <table>
          ...
          <button type="submit" class="form-submit">Habilitar Vehiculo </button>
...
fechades
      ...
      console.log("fechades:"+fechades);
      
       $.ajax({
         type: "POST",
         url: "Ctrl/ctrlvehiculofunciones.php",
         data: {funcion:"habilitarvehiculo", veh_codigo:veh_codigo, fechades:fechades },

...
<body>
  ...
  <div class="container">
        <center><img src="../../../img/logo2.png"><br>
          <h1>Habilitar Tipo Combustible</h1>
      </center>
      <hr>
      <center>
      <form id="formagregarvehiculo" action="Ctrl/ctrltipocombustiblefunciones.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="funcion" value="habilitartcombustible">
        <table>
              <tr>
                  <td style="text-align: right;">Codigo:</td>
                  <td style="width: 150px"><input type="number" id="codmodelo" name="codtcombustible" value="<?php echo $getcombustible[0]['TCOMB_CODIGO'] ?>" readonly></td>
              </tr>
              <tr>
          ...
          <button type="submit" class="form-submit">Habilitar Tipo Combustible</button>

...
<body>
  <div class="container">
          ...
          <center><table style="width:auto; max-width: 100%;">
              ...
              <tr>              
                  ...
                  <td style="background-color: white;width: auto"> <select name="datobuscar" id="datobuscar" style="width: 180px; border-color: black" class="btn btn-block">
                              ...
                              <option value="a.TCOMB_CODIGO">Codigo</option>
                              <option value="a.TCOMB_NOMBRE">Descripción</option>
                              <option value="a.TCOMB_FECHA">Fecha</option>
                              <option value="a.TCOMB_ESTADO">Estado</option>  
                      </select> </td>    
                  ...
                  <td colspan="2"style="background-color: white;padding:1 0 0 5;">
                        <input type="button" name="volver" id="volver" class="form-submit" onclick="window.location.href='agregartcombustible.php'" value="Agregar Tipo Combustible" style=" margin-top: 3; margin-bottom: 3;width:98%; padding-top: 10px; padding-bottom: 10px;">
    ...
    $("#text").keyup(function(){ 
      ...
      $.ajax({
        "type": "POST",
        "url": "Ctrl/ctrltipocombustiblefunciones.php",
        data: {funcion:"filtertcombustible",datobuscar:datobuscar,text:text,estado:estado,anio:anio,mes:mes },
              ...
              if(lista!="error"){
                ...
                html += "<thead>";
                 ...
                 for(i = 0; i < lista.length; i++){
                  ...
                  html += "<td style='text-align:center'>"+lista[i]["TCOMB_CODIGO"]+"</td>";
                  html += "<td style='text-align:left'>"+lista[i]["TCOMB_NOMBRE"]+"</td>";
                  html += "<td style='text-align:center'>"+lista[i]["TCOMB_FECHA"]+"</td>";
                 // html += "<td style='color:"+$colortexto+";text-align:left'>"+$texto+"</td>";    
                  html += "<td><a href='vertubicacion.php?TCOMB_CODIGO="+lista[i]["TCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/view.png' width=15px' height=15px'></a>";
                  html += "<a href='modificartcombustible.php?TCOMB_CODIGO="+lista[i]["TCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/edit.png' ' width=15px' height=15px'></a>";
                  html += "<a href='imprimirtcombustibleimpresion.php?TCOMB_CODIGO="+lista[i]["TCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/imp.png' width=15px' height=15px'></a>";   
                        if(lista[i]["TCOMB_ESTADO"]==1){
                            html += "<a href='eliminartcombustible.php?TCOMB_CODIGO="+lista[i]["TCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/delete.png' width=15px' height=15px'></a>";
                            html += "</td>";
                            html += "</tr>";
                        }else{
                            html += "<a href='habilitartcombustible.php?TCOMB_CODIGO="+lista[i]["TCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/png/success.png' width=15px' height=15px'></a>";
                            html += "</td>";
                            html += "</tr>";
                        }               
                    }

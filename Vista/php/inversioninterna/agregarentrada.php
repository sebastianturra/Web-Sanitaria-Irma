...
<body>
    <div class="container">
        <div>
            ...
            <h1 style="text-align: center;">Agregar Entrada</h1>
        </div> 
    <div class="tablas">           
        ...
        enctype="multipart/form-data"> 
            ...
            <input type="hidden" name="ne_salent_salida" id="id_salent_salida" value="<?php echo $id ?>"> 
            ...
            <input type="hidden" name="funciones" value="crearentrada">      
            <table style="width: 87%; margin: 0 auto;">
                <tr id="menubanios1"> 
                    ...
                    <td style="width: 10%;"> 
                    <input type="date" name="ne_bodi_fecha" id="id_bodi_fecha" value="<?php echo $salent[0]['salent_fecha'] ?>" required>
                    </td>
                </tr>
                <tr id="menubanios2">     
                <td>
                    ...
                    <td> 
                        <input style="width: 100%"type="text" name="ne_salent_empresa" id="id_salent_empresa" value="<?php echo $salent[0]['salent_empresa'] ?>" readonly>    
                    </td>    
                    <td>
                     Hora:
                    </td>         
                    <td><input type="time" name="ne_salent_hora" id="id_salent_hora" value="<?php echo $salent[0]['salent_hora'] ?>" required>
                    </td>  
                </tr>
                <tr id="menubanios3">    
                    <td>
            ...
            <div class="botones">
                <button type="submit" class="form-submit">Agregar Entrada</button>

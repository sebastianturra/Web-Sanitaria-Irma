...
<body>
    <div class="container">
        <div>
            ...
            <h1 style="text-align: center;">ELIMINAR <?php echo $op ?> <?php echo $codigo ?></h1>
        </div> 
    <div class="tablas">           
        ...
        enctype="multipart/form-data"> 
            ...
            <input type="hidden" name="funciones" value="eliminarsalent">      
            ...
            <div class="botones">
                <button type="submit" class="form-submit" >ELIMINAR <?php echo $op ?></button>

...
<script  type="text/javascript">
    $(document).ready(function(){
            ...
            $estado = $('#id_esti_id').val();
            alert('bodi_estado'+$estado);
            if($estado != 3){
                 alert("No se puede eliminar el inventario en el actual estado.");
                 $('#modificarbanio').prop('disabled', true);
            }
...
<body>
    ...
    <div class="tablas">           
        ...
        enctype="multipart/form-data"> 
            <input type="hidden" name="funciones" value="eliminar">    
            <input type="hidden" name="ne_bodi_id" id="id_bodi_id" value="<?php echo $banioid[0]['bodi_id']?> ">   
            <input type="hidden" name="ne_esti_id" id="id_esti_id" value="<?php echo $banioid[0]['esti_id']?> ">   
            ...
            <table style="width: 87%; margin: 0 auto;">
                <tr id="menubanios0"> 
                    ...
                    <td style="width: 10%;"> 
                    <input type="text" name="ne_bodi_estado" id="id_bodi_estado" value="<?php echo $banioid[0]['esti_desc']?>" readonly>
                    </td>
                </tr>
                <tr id="menubanios1"> 
                    <td style="width: 10%;">
            ...
            <div class="botones">
                <button type="submit" class="form-submit" id="modificarbanio">Eliminar</button>

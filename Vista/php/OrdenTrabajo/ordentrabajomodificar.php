...
$otrafecha = date("Y-m-d\TH:i:s", strtotime($getotra[0]['otra_fecha']));
$otrafechafin = date("Y-m-d\TH:i:s", strtotime($getotra[0]['otra_fechafin']));
...
<div class="container">
      ...
      <div id="menu">
       ...
       <input type="hidden" name="otra_procodigo" value="<?php echo $getotra[0]['otra_procodigo'] ?>">
       <div id="uno">
        <table class="datemp" style='width: 100%;'>
            <tr>
              <td style="text-align: right;width:1.6%">Numero Cotización:</td>
              <td colspan="2" style="background-color: white;"><input style="padding: 5 5;" type="text" id="emporden" name="otra_numcot" value="<?php echo $getotra[0]['otra_numcot'] ?>"  ></td>
              <td style="text-align: right;width:1%">Fecha Inicio:</td>  
              <td colspan="2" style="background-color: white;"><input style="padding: 5 5;" type="datetime-local" id="fecorden" name="otra_fecha" value="<?php echo $otrafecha ?>"></td>
              <td style="text-align: right;width:1.2%">Fecha Termino:</td>  
              <td colspan="2" style="background-color: white;"><input style="padding: 5 5;" type="datetime-local" id="fecorden" name="otra_fechafin" value="<?php echo $otrafechafin ?>"></td>
            </tr>
            <tr>
              <td style="text-align: right;width">Empresa:</td>
              <td colspan="3" style="background-color: white;"><input style="padding: 5 5;margin-bottom: 5px;" type="text" id="emporden" name="otra_empresa" value="<?php echo $getotra[0]['otra_empresa'] ?>"></td> 
              <td colspan="2" style="text-align: right;">Responsable:</td>
              <td colspan="3" style="background-color: white;"><input style="padding: 5 5;margin-bottom: 5px;" type="text" id="resemp" name="otra_responsable" value="<?php echo $getotra[0]['otra_responsable'] ?>"></td>
            </tr>
              <td style="text-align: right;">Patente Camion:</td>
              <td colspan="3"style="background-color: white;"><input style="padding: 5 5;" type="text" id="resemp" name="otra_patcam" value="<?php echo $getotra[0]['otra_patcam'] ?>"></td>
              <td colspan="2" style="text-align: right;">Tipo:</td>
              <td colspan="3" style="background-color: white;"><input style="padding: 5 5;" type="text" id="rutcta" name="otra_eqcamion" value="<?php echo $getotra[0]['otra_eqcamion'] ?>"></td>              
            </tr>
            <tr>
              <td style="text-align: right;">Correo:</td>
              <td colspan="4" style="background-color: white;"><input style="padding: 5 5;margin-bottom: 5px;" type="text" id="cemp" name="otra_correo" value="<?php echo $getotra[0]['otra_correo'] ?>"></td>
              <td style="text-align: right;">Dirección:</td>
              <td colspan="3" style="background-color: white;"><input style="padding: 5 5;margin-bottom: 5px;" type="text" id="cemp" name="otra_direccion" value="<?php echo $getotra[0]['otra_direccion'] ?>"></td>
            </tr>
            <tr>
              <td style="text-align: right;">Telefono:</td>
              <td colspan="2" style="background-color: white;"><input style="padding: 0;margin-bottom: 5px;" type="text" id="rutcta" name="otra_telefono" value="<?php echo $getotra[0]['otra_telefono'] ?>"></td>             
            <tr>
          </table>  
        </div>
        <div id="uno">
        ...
        for($p=0; $p<$totalproductoscotizacion;$p++){
            echo "
            <input type='hidden' name='dotra_codigo[]' value='".$detalleordencompra[$p]['dotra_codigo']."'>
            <tr><td style='text-align: center;width: 35px;'>".($i+1)."</td>".
            "<td><input style='padding: 6px 2px' type='text' name='dotra_desc[]' value='".$detalleordencompra[$p]['dotra_desc']."'></td>".
            "<td><select name='dotra_estado[]' class='btn btn-block'>";
            if($detalleordencompra[$p]['dotra_estado']=="Completado"){
         echo "<option value='Completado' SELECTED>Completado</option>".
              "<option value='En Proceso'>En Proceso</option>".
              "<option value='Cancelado'>Cancelado</option></select>";
            }else if($detalleordencompra[$p]['dotra_estado']=="En Proceso"){
         ...
         echo "<option value='Completado'>Completado</option>".
              "<option value='En Proceso'>En Proceso</option>".
              "<option value='Cancelado'SELECTED>Cancelado</option></select>";
            }
         echo "</td>";
            $i++;
        } 
      ...
      <div id="botones">
      <center> 
        <button id="acot" type="submit" class="form-submit">Modificar Orden de Trabajo</button>

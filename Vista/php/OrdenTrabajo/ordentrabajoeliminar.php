...
<div class="container">
      ...
      <div id="menu">
       ...
       <div id="uno">
        ...
        for($p=0; $p<$totalproductoscotizacion;$p++){
            ...
            "<td><input style='padding: 6px 2px' type='text' name='dotra_estado[]' value='".$detalleordencompra[$p]['dotra_estado']."'></td>";
            $i++;
        } 
    }      
        ?>
      ...
      <div id="botones">
      <center> 
        <button id="acot" type="submit" class="form-submit">Eliminar Orden de Trabajo</button>

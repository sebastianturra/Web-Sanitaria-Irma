      ...
      <form id="formagregarvehiculo" action="Ctrl/ctrlubicacionfunciones.php" method="post" enctype="multipart/form-data">
        ...
        <table>
              ...
              <tr>
                  ...
                  <td style="width: 150px"><input type="text" name="udesc" value="<?php echo $getubicacion[0]['UB_DESCRIPCION'] ?>" readonly></td>
              </tr>
              <tr>
                  <td style="text-align: right;">Fecha:</td>
                  <td style="width: 150px"><input type="date" name="ufecha" value="<?php echo $getubicacion[0]['UB_FECHA'] ?>" readonly></td>
              </tr>
              <tr>
          ...
          <button type="submit" class="form-submit">Habilitar Ubicación</button>

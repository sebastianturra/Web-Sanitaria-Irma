...
<body>
  <div class="container">
          ...
          <center><table style="width:auto; max-width: 100%;">
              ...
              <tr>              
                  ...
                  <td style="background-color: white;width: auto"> <select name="datobuscar" id="datobuscar" style="width: 180px; border-color: black" class="btn btn-block">
                              ...
                              <option value="a.UB_CODIGO">Codigo</option>
                              <option value="a.UB_DESCRIPCION">Descripción</option>
                              <option value="a.UB_FECHA">Fecha</option>
                              <option value="a.UB_ESTADO">Estado</option>  
                      </select> </td>    
                  ...
                  <td colspan="2"style="background-color: white;padding:1 0 0 5;">
                        <input type="button" name="volver" id="volver" class="form-submit" onclick="window.location.href='agregarubicacion.php'" value="Agregar Ubicación" style=" margin-top: 3; margin-bottom: 3;width:98%; padding-top: 10px; padding-bottom: 10px;">
    ...
    $("#text").keyup(function(){ 
      ...
      $.ajax({
        "type": "POST",
        "url": "Ctrl/ctrlubicacionfunciones.php",
        data: {funcion:"filterubicacion",datobuscar:datobuscar,text:text,estado:estado,anio:anio,mes:mes },
              ...
              if(lista!="error"){
                ...
                html += "<thead>";
                 ...
                 for(i = 0; i < lista.length; i++){
                  ...
                  html += "<td style='text-align:center'>"+lista[i]["UB_CODIGO"]+"</td>";
                  html += "<td style='text-align:left'>"+lista[i]["UB_DESCRIPCION"]+"</td>";
                  html += "<td style='text-align:center'>"+lista[i]["UB_FECHA"]+"</td>";
                 // html += "<td style='color:"+$colortexto+";text-align:left'>"+$texto+"</td>";    
                  html += "<td><a href='verubicacion.php?UB_CODIGO="+lista[i]["UB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/view.png' width=15px' height=15px'></a>";
                  html += "<a href='modificarubicacion.php?UB_CODIGO="+lista[i]["UB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/edit.png' ' width=15px' height=15px'></a>";
                  html += "<a href='imprimirubicacionimpresion.php?UB_CODIGO="+lista[i]["UB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/imp.png' width=15px' height=15px'></a>";   
                        if(lista[i]["UB_ESTADO"]==1){
                            html += "<a href='eliminarubicacion.php?UB_CODIGO="+lista[i]["UB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/delete.png' width=15px' height=15px'></a>";
                            html += "</td>";
                            html += "</tr>";
                        }else{
                            html += "<a href='habilitarubicacion.php?UB_CODIGO="+lista[i]["UB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/png/success.png' width=15px' height=15px'></a>";
                            html += "</td>";
                            html += "</tr>";
                        }               
                    }

...
document.getElementById("text").disabled = true;
              ...
              $("#gpdf").click(function(){
               ...
               alert('llego hasta aca1');
                ...
                document.getElementById('tabla-contenidopdf').innerHTML="<iframe src=Ctrl/ctrlgenerarbienespdf.php?text="+text+"&datobuscar="+datobuscar+"&mes="+mes+"&anio="+anio+"&estado="+estado+"&ubicacion="+ubicacion+" style='width:100%; height:100%; border: 0;'></iframe>";

                alert('llego hasta aca2');

              });  

          /*    datobuscar="+$datobuscar+"&text="+$text+"&mes="+$mes+"&anio="+$anio+"&estado="+$estado+"&ubicacion="+$ubicacion+" */
      ...
      <div id="menu">
           <center><table style="width:auto; max-width: 100%;">
              ...
              <tr>
                  ...
                  <td style="width:auto;background-color: white"> <select name="estado" id="estado" style="width:100%; border-color: black" class="btn btn-block busqueda">
                  ...
                  <td style="width:auto;background-color: white"> <select name="ubicacion" id="ubicacion" style="width:100%; border-color: black" class="btn btn-block busqueda">
                              <?php
          ...
          console.log(lista.length); 
                if(lista!="error"){
                 ...
                 html += "<th style='text-align:center' rowspan='2'>Operaciones</th>";
                  ...
                  html += "<tr>";
                 html += "<th style='text-align:center' >Bueno</th>";

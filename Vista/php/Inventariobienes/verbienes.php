      ...
      <form id="formagregarvehiculo" action="">
        ...
        <!--  <input type="hidden" name="funcion" value="agregarbiene">  -->
              <tr>
                  ...
                  <td style="width: 150px"><input type="text" id="itemdesc" name="itemdesc" value="<?php echo $items[0]['ITEM_NUMIDEN'] ?>" disabled></td>
              </tr>
              <tr>
             ...
             <tr>
              ...
              <td style="background-color: white;"><input type="text" id="valor" name="valor" value="<?php echo $items[0]['ITEM_VALOR'] ?>" readonly></td>
            </tr>
          </table>

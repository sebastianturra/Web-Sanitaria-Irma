  ...
  <div class="container">
      ...
      <form id="formagregarvehiculo" action="">
        <table>
          ...
          <input type="hidden" name="funcion" value="modificarbien">  
              <tr>
                  <td style="text-align: right;">Numero:</td>
                  <td style="width: 150px"><input type="text" id="itemdesc" name="numero" value="<?php echo $items[0]['ITEM_NUMIDEN'] ?>" readonly></td>
              </tr>
              <tr>
                  <td style="text-align: right;">Descripción:</td>
                  <td style="width: 150px"><input type="text" id="itemdesc" name="itemdesc" value="<?php echo $items[0]['ITEM_DESC'] ?>" required></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td style="width: 150px"><input type="text" id="marca" name="marca" value="<?php echo $items[0]['ITEM_MARCA'] ?>" required></td>
              </tr>
              <tr>
                  <td style="text-align: right;">Fecha de Ingreso:</td>
                  <td style="width: 150px"><input type="date" id="fechaing" name="fechaing" value="<?php echo $items[0]['ITEM_FECHAING'] ?>" required></td>
              </tr>
              <tr>
                  <td style="text-align: right;">Cantidad:</td>
                  <td style="background-color: white;"><input type="number" id="itemcant" name="itemcant" value="<?php echo $items[0]['ITEM_CANT'] ?>" required></td>
              </tr>
              <tr>
            ...
            <tr>
              ...
              <td style="background-color: white;"><input type="text" id="valor" name="valor" value="<?php echo $items[0]['ITEM_VALOR'] ?>" ></td>
            </tr>
          </table>

          <button type="submit" class="form-submit">Modificar Item</button>

...
<body>
  <div class="container">
      <center><img class="logo" src="../../../img/logo2.png"><br>
      ...
      <div id="menu-opcion">
          <center><table style="width:50%;">
              <tr>
                  <td style="width:40%;background-color: skyblue; color: white; font-weight: bold;"> Tipo de Usuario</td>
                  <td style="width:60%;background-color: white"> <select name="tusu" id="tusu" style="border-color: black" class="btn btn-block">

   ...
   if($totalproductoscotizacion!=0){         
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="obscot" rows="3" style="width: 400px;" placeholder="Ingrese observación" readonly><?php echo $Cotizacion[0]['COT_OBSERVACION'] ?></textarea></td>
            </tr>
          </table>  

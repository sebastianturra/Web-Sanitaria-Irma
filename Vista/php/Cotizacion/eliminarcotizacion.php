...
<link rel="shortcut icon" type="image/x-icon" href="../../../img/logopestanaico.ico" />
<title>Eliminar Cotización - Sistema Salitrera Irma Ltda</title>
...
<div class="container">
      ...
      <div id="menu">
       ...
       <form id="formcrecot" action ="">
          <input type="hidden" name="cotcodigo" value="<?php echo $cotcodigo ?>">
      ...
      <center><table>
              <tr>
                 ...
                 <td style="width: auto; background-color: skyblue; color: white; font-weight: bold;"> Estado Proceso Cotización</td>
                  <td style="width: auto; background-color: white"> <select name="opcionestado" id="opcionestado" style="width: auto; border-color: black" class="btn btn-block" disabled>
                       <?php
       ...
       <table id="condicionesventa" style="float:left;"class="datcotpie">
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="obscot" style="width: 400px;" placeholder="Ingrese observación" readonly><?php echo $Cotizacion[0]['COT_OBSERVACION'] ?></textarea></td>
            </tr>
          </table>  
          <table  style="float:right; border: 1px solid black; width: 40%;" class="datcotpie">
            <tr id="condicionesventa2">
              <td style="font-weight: normal;text-align: justify;background-color: white;">
                <textarea id="condcot" name="condcot" style="width: 400px; height: 190px;text-align: justify;" placeholder="Ingrese observación" readonly><?php echo $Cotizacion[0]['COT_CONDICIONES'] ?></textarea>
            </tr>
          </table>
        </div>
        <div class="botones">
    <center>    
        <button type="submit" class="form-submit" id="elicot">Eliminar Cotización</button>

      ...
      <fieldset>
          ...
          <table class="datemp" style='width: 100%;'>
            <tr>
             ...
             <td colspan="8" style="background-color: white;width: 240px;"><select style="width: 100%; border-color: black" class="btn btn-block" id="empcotcod" name="empcotcod">
                <?php 
                  foreach($datars AS $key=>$value){
                    if($datars[$key]['COT_CODIGO']==$Cotizacion[0]['COT_CODIGO']){
                      echo "<option value='".$datars[$key]['COT_CODIGO']."' SELECTED>".$datars[$key]['COT_RUT']."-".$datars[$key]['COT_DIRECCION']."-".$datars[$key]['COT_EMPRESA']."</option>";
                    }else{
                      echo "<option value='".$datars[$key]['COT_CODIGO']."' >".$datars[$key]['COT_RUT']."-".$datars[$key]['COT_DIRECCION']."-".$datars[$key]['COT_EMPRESA']."</option>";
                    } 
                  }
                ?>
              </select>
              <input type="hidden" name="empnombre" id="empnombre" value="<?php echo $Cotizacion[0]['COT_EMPRESA']?>">
             </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2" style="background-color: white;padding: 5 4"><input type="text" id="cot_giro" name="cot_giro" value="<?php echo $Cotizacion[0]['COT_TGIRO'] ?>"></td>
              <td  style="text-align: right;">Rut:</td>
              <td colspan="2" style="background-color: white;"><input type="text" id="cot_rut" name="cot_rut" value="<?php echo $Cotizacion[0]['COT_RUT'] ?>"></td>
              <td  style="text-align: right;">Correo:</td>
              <td colspan="2" style="background-color: white;"><input type="text" id="cot_correo" name="cot_correo" value="<?php echo $Cotizacion[0]['COT_CORREO'] ?>"></td>
            </tr> 
          </table>  
        </div>
        <?php  
   ...
   if($totalproductoscotizacion!=0){         
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="obscot" rows="3" style="width: 400px;" placeholder="Ingrese observación" ><?php echo $Cotizacion[0]['COT_OBSERVACION'] ?></textarea></td>
            </tr>
          </table>  
          <table  style="float:right; border: 1px solid black; width: 40%;" class="datcotpie">
            <tr id="condicionesventa2">
              <td style="font-weight: normal;text-align: justify;background-color: white;">
                <textarea id="condcot" name="condcot" style="width: 400px; height: 190px;text-align: justify;" placeholder="Ingrese observación"><?php echo $Cotizacion[0]['COT_CONDICIONES'] ?></textarea>
            </tr>
          </table>
        </div>
        <div class="botones">

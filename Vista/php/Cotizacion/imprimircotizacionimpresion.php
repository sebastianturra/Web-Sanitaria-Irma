...
<link rel="shortcut icon" type="image/x-icon" href="../../../img/logopestanaico.ico" />
<title>Cotización - Sanitaria Irma Ltda</title>
       ...
       <table id="condicionesventa" style="float:left;"class="datcotpie">
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="obscot" cols="3" style="width: 400px;" readonly><?php echo $Cotizacion[0]['COT_OBSERVACION'] ?></textarea></td>
            </tr>
          </table>  

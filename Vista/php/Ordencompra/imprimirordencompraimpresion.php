   ...
   if($totalproductoscotizacion!=0){         
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="OCOM_OBSERVACION" cols="50" rows="2" placeholder="Ingrese Comentario"><?php echo $resultadogetorden[0]['OCOM_OBSERVACION']?></textarea></td>
            </tr>
          </table>  
        </div>

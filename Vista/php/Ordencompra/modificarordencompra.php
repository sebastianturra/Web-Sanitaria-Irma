...
/*
echo '<pre>',var_dump($datars),'</pre>';
echo '<pre>',var_dump($resultadogetorden),'</pre>';
*/
?>
  ...
  <div class="container">
      ...
      <div id="menu">
       ...
       <form method="post" action="Ctrl/ctrl_funcionesordencompra.php" enctype="multipart/form-data">
        ...
        <input type="hidden" name="proordencompra" value="3">
      <div id="uno">
          <table class="datemp" style='width: 100%;'>
            ...
            <td colspan="8" style="background-color: white;"><input style="width:100%" type="text" id="emporden" name="empnombre" value="<?php echo $resultadogetorden[0]['OCOM_EMPRESA']?>" list="data">
              <datalist id="data">
            ...
            <tr> 
              ...
              <td colspan="2" style="background-color: white;padding: 5 4"><input type="date" id="fecorden" name="OCOM_FECHA" value="<?php echo $resultadogetorden[0]['OCOM_FECHA']?>">
              </td>
            ...
            <td style="text-align: right;">Dirección:</td>
              <td colspan="2"><input style="padding: 0;" type="text" id="dirorden" name="dircot" value="<?php echo $resultadogetorden[0]['direccion']?>"></td>
              ...
              <td colspan="2"style="background-color: white;"><input type="text" id="telcot" name="fonocot" value="<?php echo $resultadogetorden[0]['telefono']?>"></td> 
            </tr>
            <tr>
              
              <td style="width: auto;"> Tipo de Banco:</td>
              <td colspan="2" style="width: auto;"> <select name="BCO_CODIGO" id="opciones" style="width: auto; border-color: black" class="btn btn-block">
                            <?php                            
              ...
              <td colspan="2" style="width: auto;"> <select name="TCTA_CODIGO" id="tcuenta" style="width: auto; border-color: black" class="btn btn-block">
                          <?php                            
   ...
   if($totalproductoscotizacion!=0){         
        ...
        for($p=0; $p<$totalproductoscotizacion;$p++){
            ...
            <td style='border: whitesmoke solid 4px'><input style='padding: 6px 2px' type='text' name='descot[]' id='descot".$i."' placeholder='Ingrese Nombre Producto....' value='".$detalleordencompra[$p]['DCOM_DESCRIPCION']."'></td>
                    <td style='border: whitesmoke solid 4px; text-align: right'><input style='padding: 6px 2px' type='number' name='cbfcot[]' id='cbfcot".$i."' placeholder='0' class='calculo' value='".$detalleordencompra[$p]['DCOM_CBFCOT']."'></td>
                    <td style='border: whitesmoke solid 4px; text-align: center'><input style='padding: 6px 2px' type='number' name='vuncot[]' id='vuncot".$i."' placeholder='0' class='calculo' value='".$detalleordencompra[$p]['DCOM_VALUNITARIO']."' ></td>
        ...
        ?>
          ...
          <table style="float:right;" class="datcotpie">
            <tr>
              ...
              <td style="background-color: white;padding: 5 5; width: 135px;"><input style='padding: 6px 2px' type="number" id="subtotal" name="OCOM_NETO" value="<?php echo $resultadogetorden[0]['OCOM_NETO'] ?>"></td>
            </tr>
            <tr>
      ...
      <div id="tabla-contenidopdf">      
        ...
        <div class="botones">
    <center>    
        <button type="submit" class="form-submit">Modificar Orden de Compra</button>

      ...
      <div id="uno">
          <table class="datemp" style='width: 100%;'>
            ...
            <tr> 
              ...
              <td colspan="2" style="background-color: white;width: 270px;"><input style="padding: 0;" type="text" id="resemp" name="OCOM_RESPONSABLE" placeholder="Ingrese Responsable De la Empresa" value="<?php echo $resultadogetorden[0]['OCOM_RESPONSABLE']?>"></td>
            </tr>
            <tr>
            ...
            <td style="text-align: right;">Banco:</td>  
              ...
              <input type="hidden" id="cemp" name="OCOM_CORRECTA" value="<?php echo $resultadogetorden[0]['EST_PRODESCRIPCION'] ?>">
        </div>
...
$totalproductoscotizacion=$totproorden[0]["cuenta"];
   if($totalproductoscotizacion!=0){         
      ...
      <div id="tabla-contenidopdf">      
        ...
        <div class="botones">
    <center>    
      <button id="acot" type="button" onclick="window.location.href='imprimirordencompraimpresion.php?OCOM_CODIGO=<?php echo $resultadogetorden[0]['OCOM_CODIGO'] ?>'" class="form-submit">Imprimir Orden de Compra</button>

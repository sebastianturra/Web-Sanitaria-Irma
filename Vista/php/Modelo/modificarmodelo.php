...
<body>
  ...
  <div class="container">
      ...
      <form id="formagregarvehiculo" action="Ctrl/ctrlmodelofunciones.php" method="post" enctype="multipart/form-data">
        <input type="hidden" name="funcion" value="modificarModelo">
        <table>
              <tr>
                  <td style="text-align: right;">Codigo:</td>
                  <td style="width: 150px"><input type="number" id="codmodelo" name="codmodelo" value="<?php echo $getubicacion[0]['MVEH_CODIGO'] ?>" readonly></td>
              </tr>
              <tr>
                  <td style="text-align: right;vertical-align: middle;">Descripción:</td>
                  <td style="width: 150px"><input type="text" name="udesc" value="<?php echo $getubicacion[0]['MVEH_DESCRIPCION'] ?>" ></td>
              </tr>
              <tr>
                  <td style="text-align: right;">Fecha:</td>
                  <td style="width: 150px"><input type="date" name="ufecha" value="<?php echo $getubicacion[0]['MVEH_FECHA'] ?>"></td>
              </tr>
              <tr>
                  ...
                  <td style="width: 150px"><select id="estado" name="uestado" class="btn btn-block" onfocus='this.size=5;' onblur='this.size=1;' onchange='this.size=1; this.blur();'>
                    <?php
                            if($getubicacion[0]['MVEH_ESTADO']==1){
                              echo "<option value='".$getubicacion[0]['MVEH_ESTADO']."' selected>Existente</option>";
          ...
          <button type="submit" class="form-submit">Modificar Modelo</button>

          <button type="button" class="form-submit" onclick="window.location.href='../../index.php'">Volver Al Menu Principal</button>

          <button type="button" class="form-submit" onclick="window.location.href='listadomodelo.php'">Volver al listado</button>
      </form>  
</div>

...
<body>
  <div class="container">
      <center><img src="../../../img/logo2.png"><br>
          <h1>Listado de Guia Detalle Combustible</h1>
      </center>
        ...
        success: function(data){
          ...
          if(estado==0){
                ...
                html += "<thead>";
                 ...
                 html += "<tbody>";
                 html += "<tr>";
                          html += "<td colspan='11' style='text-align:center'>Debe seleccionar el estado</td>";                
                          html += "</tr>";
                          html += "</tbody>";
                ...
                html += "<thead>";
                 ...
                 html += "<tbody>";
                 html += "<tr>";
                          html += "<td colspan='12' style='text-align:center'>No Hay Registro</td>";        
                          html += "</tr>";
                          html += "</tbody>";
                        $('#tabladatos').html(html);
                      $("#errores").empty();
  ...
  <script>
    ...
    $("#estado").change(function(){ 
      ...
      $.ajax({
        "type": "POST",
        "url": "Ctrl/ctrlcombustiblefunciones.php",
        data: {funcion:"estadodetallecombustible",estado:estado,anio:anio,mes:mes},
        success: function(data){
          console.log(data);
          var lista = eval(data); 
          console.log(lista.length);
            ...
            var html = "";
                ...
                html += "<thead>";
                 ...
                 html += "<tbody>";
                 html += "<tr>";
                      html += "<td colspan='12' style='text-align:center'><strong>DEBE SELECCIONAR EL ESTADO</strong></td>";
                      html += "</tr>";
                      html += "</tbody>";
              ...
              if(lista!="error"){
                ...
                for(i = 0; i < lista.length; i++){
                  ...
                  html += "<td style='text-align:center'>"+lista[i]["GCOMB_EXENTO"]+"</td>";
                  html += "<td style='text-align:center'>"+lista[i]["GCOMG_FECHA"]+"</td>";
                  html += "<td style='color:#ff1900;text-align:center'>"+lista[i]["EGCOM_DESC"]+"</td>"; 
                  html += "<td><a href='verguiacombustible.php?GCOMB_CODIGO="+lista[i]["GCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/view.png' width=15px' height=15px'></a>";
                  html += "<a href='modificarguiacombustible.php?GCOMB_CODIGO="+lista[i]['GCOMB_CODIGO']+"&COMB_CODIGO="+lista[i]['COMB_CODIGO']+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/edit.png' ' width=15px' height=15px'></a>";
                  html += "<a href='imprimirguiacombustibleimpresion.php?GCOMB_CODIGO="+lista[i]["GCOMB_CODIGO"]+"' class='btn' style='margin: 0 3 0 0'><img src='../../../img/icon/imp.png' width=15px' height=15px'></a>";
                  html += "<a href='habilitarguiacombustible.php?GCOMB_CODIGO="+lista[i]["GCOMB_CODIGO"]+"' class='btn' style='margin: 3 0 0 0'><img src='../../../img/png/success.png' width=15px' height=15px'></a>";
  ...
  <script>
    ...
    $("#anio").change(function(){ 
      ...
      $.ajax({
        "type": "POST",
        "url": "Ctrl/ctrlcombustiblefunciones.php",
        data: {funcion:"aniodetallecombustible",estado:estado,anio:anio,mes:mes},
        success: function(data){
          console.log(data);
          var lista = eval(data); 
          console.log(lista.length);
  ...
  <script>
    ...
    $("#mes").change(function(){ 
      ...
      $.ajax({
        "type": "POST",
        "url": "Ctrl/ctrlcombustiblefunciones.php",
        data: {funcion:"mesdetallecombustible",estado:estado,anio:anio,mes:mes},
        success: function(data){
          console.log(data);
          var lista = eval(data); 
          console.log(lista.length);

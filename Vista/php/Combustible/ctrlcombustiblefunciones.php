                ...
                $vehiculos=$resultadovehiculos;
                 ...
                 for ($i=0; $i < count($fechas); $i++) { 
                  for ($a=0; $a < count($vehiculos); $a++) {             
                    ...
                    $validadorvehiculolitrovehiculo = $Combustibles->validadorlitrosvehiculo($codigovehiculo,$meses,$diasmes);
    ...
    //echo "<script> alert('Los meses son: ".$meses." Los años son: ".$anio."'); </script>"; 
               ...
               // var_dump($fechas);
                ...
                //OBTIENE LOS NOMBRES DE LOS DIAS DE LAS SEMANA.
                 ...
                 //OBTIENE LOS VEHICULOS DEL MES(YA VALIDADO POR METODO)
                $vehiculos = array();
                $resultadovehiculos = $Combustibles->vehiculomes($meses,$anio);
                $vehiculos=$resultadovehiculos;  
             ...
             // $resultado = $Combustibles->listadovehiculosmeslitros($codigovehiculo,$fecha);
              $resultado = $Combustibles->listadovehiculosmeslitros($meses);
              $vararraycontador=0;
              for ($i=0; $i < count($fechas); $i++) { 
                 for ($a=0; $a < count($vehiculos); $a++) {             
                   $fecha=$fechas[$i];
                ...
                $resultadolitrosvehiculos =  $Combustibles->litrosmesvehiculo($meses);
             ...
             $obtenerfacturas = $Combustibles->obtenerfacturasmes($meses);
             ...
             $resultadoguiasdespacho = $Combustibles->obtenerguiasdespachomes($meses);
             ...
             for ($i=0; $i < $diasmes; $i++) { //30 dias del mes
              ...
              if($resultadoguiasdespacho=='error'){
                ...
                /*  $data[$i]['gdlcar0'] = 0;
                  ...
                  $resultadopordia = $Combustibles->litrospordiavehiculosmes($meses);
                  for ($i=0; $i < $diasmes; $i++) {  //30 dias del mes
                   // $fecha = $data[$i]['fecha'];

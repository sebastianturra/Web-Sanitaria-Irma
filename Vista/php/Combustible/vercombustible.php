...
<body>
	...
	<div class="container">
			...
			<form id="formagregarvehiculo" action="">
                ...
                echo "</select></td></tr>";
                echo "<tr><td style='color:$variable'>Carga Vehiculo $incrementado</td><td><input type='text' id='carga$i' name='carga[]' value='".$compexternas[$i]["CEXT_LCAR"]."' readonly></td></tr>";
                ...
                echo "</select></td></tr>";
					...
					<button type="button" class="form-submit" onclick="window.location.href='AgregarGuiaCombustible.php?COMB_CODIGO=<?php echo $combustible[0]['COMB_CODIGO'] ?>&&datobuscar=2'">Agregar Guia Complementaria </button>

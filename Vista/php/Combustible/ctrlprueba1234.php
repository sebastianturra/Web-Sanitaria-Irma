...
2    INT. TIGHT SPACE - INDETERMINATE TIME                           2
     ...
     Its THOR. His beard is long and his clothes are worn. That
...
for($i=0;$i<count($explode);$i++){
    if($explode[$i]=='THOR'){
        $explode[$i]='<br> THOR <br>';
    }else if($explode[$i]=='HELA'){
        $explode[$i]='<br> HELA <br>';
    }else if($explode[$i]=='LOKI'){
        $explode[$i]='<br> LOKI <br>';
    }else{
        //nada
    }
}

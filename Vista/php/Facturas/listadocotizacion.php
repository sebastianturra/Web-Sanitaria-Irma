...
<body>
          ...
          <input type="hidden" id="fechaactual" name="fechaactual" value="<?php echo $fecha ?>">
              ...
              <tr>              
                  ...
                  <td style="background-color: white;padding:1 0 0 5;">
                        ...
                        <input type="button" name="volver" id="volver" class="form-submit" onclick="window.location.href='agregarnuevo.php'" value="Agregar Cotización" style=" margin-top: 3; margin-bottom: 3;width:98%; padding-top: 10px; padding-bottom: 10px;">
                  </td> 
              ...
              <tr>
			    ...
			    <!--  <option value="4">Todas los anteriores</option>  -->
  ...
  <script>
    ...
    $(".busqueda").change(function(){ 
      ...
      //var variable = "1";
      console.log("Tipo cotizacion: "+tipocot);

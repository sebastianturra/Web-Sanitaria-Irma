...
<script type='text/javascript' src="//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
    ...
    <body>
        <div id="contenedor" >
          <table>
                        <tr>
                            <td style="width:700px;"><img src="../../../../img/logo3.png" style="width: 90%; height: 15%;"></td>
                        </tr>
                        <tr>
                            <td style="width:700px;"> 
                                <h4>Estado De Pago Entre Meses</h4>
                            </td>
                        </tr>
                    </table>
            <table >
            ...
            <tr>
                ...
                <td><?php echo ($dataNum[0]["cantidad"]+$dataNum2[0]["cantidad"]); ?></td>
            ...
            <table table style="width: 100%; max-width: 100%; margin:auto;">
                <tr>
                    <td>
         ...
         echo "<tr>";
              ...
              echo "<tr>";
                  echo "<td >Fosas</td>";
                  echo "<td >".($dataNum[0]["suma"]+$dataNum2[0]["suma"])."</td>";
            ...
            <tr>
                ...
                <td><?php echo  ($dataNumEntr[0]["suma"]+$dataNumEntr2[0]["suma"]); ?></td>
                <td ><?php echo"$".number_format($datacli[0]["vale"],0,",","."); ?> </td>
                <td><?php echo"$".number_format((($dataNumEntr[0]["suma"]+$dataNumEntr2[0]["suma"])*$datacli[0]["vale"]),0,",","."); ?></td>
               
            </tr>
                  <tr>
                <td style="background-color:skyblue;     font-weight: bold;"> Retiro</td>
                <td><?php echo ($dataNumRet[0]["suma"]+$dataNumRet2[0]["suma"]); ?></td>
                <td ><?php echo"$".number_format($datacli[0]["valr"],0,",","."); ?></td>
                <td><?php echo"$".number_format((($dataNumRet[0]["suma"]+$dataNumRet2[0]["suma"])*$datacli[0]["valr"]),0,",","."); ?></td>
               
            </tr>
                  <tr>
                <td style="background-color:skyblue;     font-weight: bold;"> Mantenciones</td>
                <td><?php echo ($dataNumMant[0]["suma"]+$dataNumMant2[0]["suma"]); ?></td>
                <td><?php echo"$".number_format($datacli[0]["vbanho"],0,",","."); ?></td>
                <td><?php echo"$".number_format((($dataNumMant[0]["suma"]+$dataNumMant2[0]["suma"])*$datacli[0]["vbanho"]),0,",","."); ?></td>
        ...
        <br>
             ...
             <table style="width: 100%; max-width: 100%; margin:auto;">
                <tr>
                   ...
                   echo "<td   style='width: 50%; font-weight: bold; font-size: 18px;'>$".number_format ( ($dataNum[0]["suma"]+$dataNum2[0]["suma"])*$datacli[0]["vlimpf"] , 0 ,  "," ,  "." )."</td>";
                           }else{
                    ?>
                    <td style="width: 50%;background-color:skyblue; font-size: 18px; font-weight: bold;">TOTAL VALOR NETO</td>
                    <td style="width: 50%; font-weight: bold; font-size: 18px;"><?php echo " $".number_format (($dataNumEntr[0]["suma"]+$dataNumEntr2[0]["suma"])*$datacli[0]["vale"]+($dataNumRet[0]["suma"]+$dataNumRet2[0]["suma"])*$datacli[0]["valr"]+($dataNumMant[0]["suma"]+$dataNumMant2[0]["suma"])*$datacli[0]["vbanho"] , 0 ,  "," ,  "." );  ?></td>
                  <?php
                           }
                           ?>
                </tr>
      ...
      <?php
         ...
         echo "<tr>"
            ...
            <table style="width: 100%; max-width: 100%; margin:auto;">
              ...
              <td style="width: 50%;background-color:skyblue;     font-weight: bold;">Observación</td>
              </tr>             
                      <?php
            $i=0;
            while($i<count($datapago)){
              ...
              echo "<td style='width: 100px;word-wrap: break-word;'>".$datapago[$i]["repobs"]."</td>";
              echo "</tr>";
                     }
              $i++;
            }
            ...
            while($i<count($datapago2)){
              ...
              echo "<td style='width: 100px;word-wrap: break-word;'>".$datapago2[$i]["repobs"]."</td>";
              echo "</tr>";
                       }     
              $i++;
            }

...
<script  type="text/javascript">
   $(document).ready(function() {
          ...
          $("#numpro").keyup(function(){
              ...
              "<input type='hidden' name='iva[]' id='iva"+i+"' value='1'><input style='padding: 6px 2px' type='hidden' name='vuncot[]' id='vuncot"+i+"' class='calculo' value='1'></td>"+
  ...
  <div class="container">
     ...
     <!--    <h1>Cotización Salitrera Irma Limitada N°<?php echo $resultado ?></h1>  -->
      ...
      <fieldset>
        ...
        <div id="uno">
          <table class="datemp" style='width: 100%;border'>
            <tr>
              <td colspan="1" style="text-align: right;">Empresa:</td>
             <td colspan="8" style="background-color: white;width: 240px;"><input type="text" id="empcot" name="empcot"></td>
            </tr>
            <tr>
      ...
      <!--      <tr>
              ...
              <td style="background-color: white;padding: 5 4"><input type="date" id="feccot" name="feccot" value="<?php echo $fecha?>"></td>
              <td style="text-align: right;">Telefono:</td>
              <td style="background-color: white;width: 100%;"><input type="number" id="telcot" name="telcot"></td>
              <td style="text-align: right;">Contacto:</td>
              <td style="background-color: white;"><input type="text" id="concot" name="concot"></td>
            </tr>
            <tr>
              <td style="text-align: right;">Tipo de giro:</td>  
              <td style="background-color: white;padding: 5 4"><input type="text" id="feccot" name="cot_giro"></td>
              <td style="text-align: right;">Rut:</td>
              <td style="background-color: white;width: 100%;"><input type="text" id="telcot" name="cot_rut"></td>
              <td style="text-align: right;">Correo:</td>
              <td style="background-color: white;"><input type="text" id="concot" name="cot_correo"></td>
            </tr>  
        -->
            <tr>
              <td  style="text-align: right;">Fecha:</td>  
              ...
              <td style="text-align: right;">Telefono:</td>
              <td colspan="2"style="background-color: white;width: 100%;"><input type="number" id="telcot" name="telcot"></td>
              <td style="text-align: right;">Contacto:</td>
              <td colspan="2"style="background-color: white;"><input type="text" id="concot" name="concot"></td>
            </tr>
            <tr>
              <td  style="text-align: right;">Tipo de giro:</td>  
              <td colspan="2" style="background-color: white;padding: 5 4"><input type="text" id="feccot" name="cot_giro"></td>
              <td  style="text-align: right;">Rut:</td>
              <td colspan="2"style="background-color: white;"><input type="text" id="telcot" name="cot_rut"></td>
              <td  style="text-align: right;">Correo:</td>
              <td colspan="2" style="background-color: white;"><input type="text" id="concot" name="cot_correo"></td>
            </tr>   
            <tr>
        ...
        <div id="uno">
          <table style="display: inline;"class="datcotpie">
            <tr>
            <td style="background-color: white;"><textarea id="obscot" name="obscot" style="width: 400px; height: 180px;max-height: 190px;" placeholder="Ingrese Comentario"></textarea></td>
            </tr>
          </table>  
          <table  style="float:right; border: 1px solid black; width: 40%;" class="datcotpie">
            <tr id="condicionesventa2">
              <td style="font-weight: normal;text-align: justify;background-color: white;">
                <textarea id="condcot" name="condcot" style="width: 400px; height: 210px;max-height: 250px;text-align: justify;" placeholder="Ingrese observación"></textarea>
            </tr>
          </table>
        </div>
</fieldset>

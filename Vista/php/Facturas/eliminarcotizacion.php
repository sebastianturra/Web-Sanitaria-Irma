      ...
      ?>
       ...
       <table id="condicionesventa" style="float:left;"class="datcotpie">
          <tr>
            ...
            <td style="background-color: white;width: 150px;"><input type="text" id="cvecot" name="cvecot" maxlength="3" style="text-align: center;" value="<?php echo $Cotizacion[0] ?>" readonly>dias</td> 
            </tr>
          </tr>
        </table>  

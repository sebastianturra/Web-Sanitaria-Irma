  ...
  <div class="container">
                  ...
                  <td style="width: auto; background-color: white"> <select name="opcionestado" id="opcionestado" style="width: auto; border-color: black" class="btn btn-block" disabled>
                       <?php
                            ...
                            foreach($getestprocesocotizacion as $tipoentidad){
                              if($tipoentidad["EST_COTCODIGO"] == $Cotizacion[0]['EST_PROCODIGO']){
        ...
        <div id="uno">
          <table class="datemp" style='width: 100%;'>
            ...
            <tr>
             ...
             <td colspan="5" style="background-color: white;width: 270px;"><input type="text" id="dircot" name="dircot" style="text-align:left;" value="<?php echo $Cotizacion[0]['COT_DIRECCION'] ?>" readonly></td>
            </tr>
            <tr>
   ...
   if($Detallecotizacion!="Nada encontrado"){         
      ...
      while ( $i<11) {
        ...
        <div class="botones">
    <center>    <button type="button" class="form-submit" onclick="window.location.href='modificarcotizacion.php?COT_CODIGO=<?php echo $Cotizacion[0]['COT_CODIGO'] ?>'">Editar Cotización</button>
